...
# Step 9: 审查模块——SQLAlchemy 2.0 ORM，生产 PostgreSQL / dev SQLite
...
_review_engine = create_async_engine(
    settings.DATABASE_URL.replace("aiosqlite", "aiosqlite"),
    echo=False,
)
...
_diagnostic_service = DiagnosticService(os.getcwd())
