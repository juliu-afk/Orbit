...
<div class="sg"><div class="sl">Theme</div><div class="flex gap-2"><button class="tb" :class="{active:s.theme==='dark'}" @click="s.theme='dark'">Dark</button><button class="tb" :class="{active:s.theme==='light'}" @click="s.theme='light'">Light</button></div></div>
  <!-- UX #14: 语言切换 -->
  <div class="sg"><div class="sl">Language / 语言</div><div class="flex gap-2"><button class="tb" :class="{active:s.locale==='zh-CN'}" @click="s.locale='zh-CN'">中文</button><button class="tb" :class="{active:s.locale==='en'}" @click="s.locale='en'">English</button></div></div>
