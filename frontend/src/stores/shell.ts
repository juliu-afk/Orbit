...
export const useShellStore = defineStore('shell', () => {
  ...
  function closeAllDrawers() { showDAG.value = false; showChart.value = false; showSearch.value = false; showSchedule.value = false; showTrace.value = false; showConfig.value = false }
  return { showFileTree, showMonaco, showDAG, showChart, showSearch, showSchedule, showTrace, showConfig, selectedFile, quoteTarget, toggleFileTree, openFileReview, closeFileReview, setQuoteTarget, toggleDAG, toggleChart, toggleSearch, toggleSchedule, toggleTrace, toggleConfig, closeAllDrawers }
})
