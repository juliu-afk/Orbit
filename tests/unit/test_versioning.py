...
class TestVersionRegistry:
    ...
    def test_install_and_current_version(self) -> None:
        reg = VersionRegistry()
        try:
    ...
    def test_install_replaces_active(self) -> None:
        reg = VersionRegistry()
        try:
    ...
    def test_list_versions_order_desc(self) -> None:
        reg = VersionRegistry()
        try:
...
class TestMigrationTracking:
    ...
    def test_record_and_check_migration(self) -> None:
        reg = VersionRegistry()
        try:
    ...
    def test_failed_migration_not_applied(self) -> None:
        reg = VersionRegistry()
        try:
...
class TestReleaseAudit:
    ...
    def test_record_release_deploy(self) -> None:
        reg = VersionRegistry()
        try:
    ...
    def test_record_release_rollback(self) -> None:
        reg = VersionRegistry()
        try:
            reg.record_release(
                "rollback",
    ...
    def test_canary_events(self) -> None:
        reg = VersionRegistry()
        try:
...
def _cleanup() -> None:
    if os.path.exists("data/versioning.db"):
        os.remove("data/versioning.db")
