...
class ClarificationEngine:
    ...
    # 互斥修饰词对 (矛盾检测)
    # P0 消重: 合并 agents/clarifier.py 的 5 对 + 原有 6 对，统一在此维护
    CONTRADICTION_PAIRS: list[tuple[str, str, str]] = [
        ...
        # ── 从 agents/clarifier.py 迁移 5 对 ──
        (r"延迟", r"全量扫描", "降低延迟与全量扫描方向冲突"),
        (r"延迟", r"遍历", "低延迟与遍历操作方向冲突"),
        (r"性能", r"实时同步", "高性能与强制实时同步方向冲突"),
        (r"离线", r"实时", "离线优先与实时要求方向冲突"),
        (r"轻量", r"引入", "轻量化与引入新依赖方向冲突"),
    ]
