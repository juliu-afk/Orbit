...
完整职责表见 [03 整体架构 §3.3](03-architecture.md#23-模块地图--module-map)。核心模块改动触发强制回归： || See [Architecture §3.3](03-architecture.md#23-模块地图--module-map) for the full responsibility table. Core module changes trigger mandatory regression:
