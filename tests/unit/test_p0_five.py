...
class TestThompsonBandit:
    ...
    def test_is_bandit_enabled(self):
        ...
        os.environ["ORBIT_ROUTER_BANDIT"] = "1"
        assert is_bandit_enabled()
...
class TestCUSUMDriftDetector:
    def test_first_update_no_alert(self):
        ...
        alert = d.update("gpt-4", latency_ms=1000, success=True, output_len=200)
    ...
    def test_normal_updates_no_alert(self):
        ...
        d = CUSUMDriftDetector()
        for _ in range(30):
            d.update("gpt-4", latency_ms=1000, success=True, output_len=200)
        alert = d.update("gpt-4", latency_ms=1050, success=True, output_len=210)
        assert alert is None
